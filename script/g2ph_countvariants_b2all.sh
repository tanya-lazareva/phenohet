...
split -l 100 ./VarCount/G2Ph_ensembl_list.csv ./VarCount/GENE; for i in $(cat ./VarCount/GENE*) ; do python3 ./script/countvariants.py --gene $i --can ./data/canonical_transcripts.txt --ann ./data/genncode.v43.annotation.gtf --gff2bed /usr/bin/gff2bed --bin 2 --dis1 ./VarCount/G2Ph_dis1_all_variants.vcf --dis2 ./VarCount/G2Ph_dis2_all_variants.vcf; done > ./VarCount/G2Ph_bins2_all_variants.csv
sed 3~2d ./VarCount/G2Ph_bins2_all_variants.csv > ./VarCount/G2Ph_bins2_all.csv
rm ./VarCount/G2Ph_bins2_all_variants.csv
